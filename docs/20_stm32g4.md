...
KiCad source files are available in the repository under `pcb/stm32g4-usbd-devboard/`. A KiCad symbol for this board (`stm32g4-usbd-devboard`) is provided in `symbols/stm32-usbd-devboards.kicad_sym`.
